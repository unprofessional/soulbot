...
const cropToMaxDimensions = async (
    ...
    if (mainMedia1.width > mainMedia1.height) {
        ...
        drawImageOptions = {
            mainMedia1,
            topCorner: 20, position, mediaMaxWidth, adjustedHeight // Destination rectangle
        };
    } else {
        ...
        drawImageOptions = {
            ...
            topCorner: 20, position, mediaMaxWidth, mediaMaxHeight // Destination rectangle
        };
    }

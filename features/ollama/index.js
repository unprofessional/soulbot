...
async function sendPromptToOllama(prompt, imagePath) {
    ...
    const catvisionprompt = 'Categorize this image with suggested meta tags. Do not infer further semantic meaning, just categorize it by tags based on what you see.';
    const requestBody = {
        model: ollamaModel,
        messages: [
            {
